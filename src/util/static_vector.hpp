...
// Most libc++ implementations do not currently provide an implementation of inplace_vector.
// This static_vector class acts very similar in concept, but to fit the requirements of a chess
// engine (no exceptions, unsafe write methods etc).
